...
|---|---|---|---|
| typecheck | FAIL | 7780 ms | src/renderer/App.tsx(98,3): error TS4114: This member must have an 'override' modifier because it overrides a member in the base class 'Component<{ children: ReactNode; }, BoundaryState, any>'. |
| tests | PASS | 14180 ms | 189/189 passed |
...
|---|---|---|---|---|---|
| PBKDF2 (310k iter, SHA-256) | 145.99 ms | 149.76 ms | 155.2 ms | 800 ms | PASS |
...
- PRECHECK [typecheck] FAIL — src/renderer/App.tsx(98,3): error TS4114: This member must have an 'override' modifier because it overrides a member in the base class 'Component<{ children: ReactNode; }, BoundaryState, any>'.
