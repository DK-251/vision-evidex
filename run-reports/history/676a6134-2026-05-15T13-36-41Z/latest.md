...
|---|---|---|---|
| typecheck | PASS | 18410 ms | — |
| tests | PASS | 24747 ms | 563/563 passed |
...
|---|---|---|---|---|---|
| PBKDF2 (310k iter, SHA-256) | 164.58 ms | 172.87 ms | 179.36 ms | 800 ms | PASS |
