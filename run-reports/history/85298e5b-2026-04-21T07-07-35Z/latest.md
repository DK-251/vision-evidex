...
|---|---|---|---|
| typecheck | PASS | 13063 ms | — |
| tests | PASS | 14530 ms | 193/193 passed |
...
|---|---|---|---|---|---|
| PBKDF2 (310k iter, SHA-256) | 145.09 ms | 151.8 ms | 159.68 ms | 800 ms | PASS |
