...
**Date:** 2026-05-11T11:26:32.878Z  
**Branch:** `main` · **Commit:** `9091b6f8`  
...
|---|---|---|---|
| typecheck | PASS | 9342 ms | — |
| tests | PASS | 11831 ms | 453/453 passed |
...
|---|---|---|---|---|---|
| PBKDF2 (310k iter, SHA-256) | 90.75 ms | 91.45 ms | 92.19 ms | 800 ms | PASS |
