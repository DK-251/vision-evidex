...
**Date:** 2026-04-18T17:03:11.978Z  
**Branch:** `main` · **Commit:** `939dfa65`  
...
|---|---|---|---|
| typecheck | PASS | 10447 ms | — |
| tests | PASS | 14401 ms | 189/189 passed |
...
|---|---|---|---|---|---|
| PBKDF2 (310k iter, SHA-256) | 144.55 ms | 145.79 ms | 147.1 ms | 800 ms | PASS |
