...
|---|---|---|---|
| typecheck | FAIL | 9536 ms | src/renderer/onboarding/UserProfileStep.tsx(113,37): error TS2379: Argument of type '{ role: string; customRole: string \| undefined; }' is not assignable to parameter of type 'Partial<ProfileDraft>'  |
| tests | PASS | 14005 ms | 192/192 passed |
...
|---|---|---|---|---|---|
| PBKDF2 (310k iter, SHA-256) | 132.07 ms | 140.55 ms | 143.85 ms | 800 ms | PASS |
